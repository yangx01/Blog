<template>
  <div class="leftBar">
    ...
    <ul class="nav nav-pills nav-stacked">
      <li role="presentation" @click="addBlog"><a>写篇文章</a></li>
      <li role="presentation" @click="blogFilter('userName','my')"><a> 我的博文</a></li>
      <li role="presentation" @click="blogFilter('userName','all')"><a>所有博文</a></li>
    </ul>
